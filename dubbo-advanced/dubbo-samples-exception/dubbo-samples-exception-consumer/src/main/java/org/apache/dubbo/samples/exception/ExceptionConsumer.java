...
public class ExceptionConsumer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("spring/exception-consumer.xml");
        context.start();
        ...
        GreetingsService exceptionService = context.getBean("exceptionService", GreetingsService.class);
        
        // 调用远程方法
        String world = exceptionService.sayHi("world");

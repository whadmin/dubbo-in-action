...
public class DirectConsumer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("spring/direct-consumer.xml");
        context.start();
        ...
        GreetingsService directService = context.getBean("directService", GreetingsService.class);
        
        // 调用远程方法
        String world = directService.sayHi("world");

...
public class LocalConsumer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("spring/local-consumer.xml");
        context.start();
        ...
        GreetingsService localService = context.getBean("localService", GreetingsService.class);
        
        // 调用远程方法
        String world = localService.sayHi("world");
